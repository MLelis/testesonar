...
@section('content_header')
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="{{ route('plans.profiles.available', $plan->id) }}">Planos</a></li>
    </ol>

    <h1>Perfis disponíveis para o perfil <strong> {{ $plan->name }} </strong></h1>
